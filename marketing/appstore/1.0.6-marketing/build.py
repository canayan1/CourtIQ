...
SHOTS = [
    ...
    },
    {
        ...
        "shot": "01_home.png",
        "eyebrow": "ONE APP",
        "head": "Your whole game,\none screen.",
        "sub": "Scenarios, wall practice, match log and doubles — pick up wherever you left off.",
        "badges": [(f"{N_SCENARIOS}", "SCENARIOS"), ("Daily", "SESSION"), ("Free", "TO PLAY")],
        "dark": False,
    },
    {
        "id": "03-wall",
        ...
        "sub": "Prop your phone behind you. It watches you swing, counts every rep, and grades the rung green, gold or try again.",
    ...
    },
    {
        ...
        "eyebrow": "REAL COACH REVIEW",
        "head": "A person watches it.\nNot an algorithm.",
        "sub": "Send one swing. Get a voice review, timestamped notes and a drill back in 72 hours.",
        "badges": [("72h", "TURNAROUND"), ("Voice", "REVIEW"), ("Human", "NOT AI")],
        "dark": False,
    },
    {
        "id": "05-the-club",
