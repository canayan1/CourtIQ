# CourtIQ App Store Metadata Draft
...
- the Today hub
- one daily IQ quiz
- the foundation training plan
- mobility previews
- read-only community threads

All Access unlocks:
- premium training tracks for footwork, shot power, flexibility, and conditioning
...
### Daily IQ
Headline: Sharpen the next point
Focus:
- daily decision-making reps
- situation-based quizzes
- pattern recognition

### Training Plans
Headline: Build tennis-specific power
Focus:
- 8-week progression
- plyometrics, hypertrophy, explosiveness, conditioning
- weekly persistence checks

### Mobility + Recovery
Headline: Move better between sessions
Focus:
- warm-up and reset flows
- serve shoulder, hips, calves, thoracic mobility
- premium recovery library
