...
- Reverse engineer, decompile, or disassemble the app, except where allowed by law.
- Resell, rent, lease, or sublicense access.
- Use CourtIQ to harass, defame, threaten, harm, or impersonate others.
- Attempt to bypass paywalls, rate limits, security, or moderation.
- Scrape, copy, or republish CourtIQ content (quizzes, training programs, mobility flows, tips, court diagrams) outside the app.
- Use CourtIQ to develop a competing product.
...
- **Billing**: handled by Apple through your App Store account.
...
- You confirm you have all rights necessary to post it and that it does not infringe on anyone else's rights.
- You accept that other users can see, quote, and respond to it.
...
- Have any heart condition, high blood pressure, joint condition, musculoskeletal injury, dizziness, chronic pain, or other medical condition;
- Are recovering from surgery or injury;
- Are pregnant or recently gave birth;
- Take any medication that could be affected by physical exertion;
- Are over 65 or have not exercised regularly in the past 6 months;
- Have any other condition that could be aggravated by exercise.
...
- The safety and condition of any racket, footwear, weights, court, gym, or other equipment or location you use;
- Warming up adequately before exercise and cooling down afterward;
...
- Any injury, disability, death, illness, loss, damage, or harm — physical, mental, emotional, financial, or otherwise — that you may suffer as a result, directly or indirectly, of using CourtIQ or performing any activity suggested by CourtIQ;
- Any decision you make based on CourtIQ content, including quiz answers, training prescriptions, mobility instructions, tips, and community discussion;
- Any interaction with other users of CourtIQ.
...
- Your use or misuse of CourtIQ;
- Your violation of these Terms;
- Your violation of any law or third-party right;
- Any content you submit to CourtIQ.
...
- CourtIQ will meet your requirements;
- CourtIQ will be uninterrupted, timely, secure, or error-free;
- The information in CourtIQ is accurate, complete, or current;
- Any defects will be corrected;
- Your use of CourtIQ will result in any particular fitness, performance, or skill outcome.
