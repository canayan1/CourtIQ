...
private struct WelcomeStep: View {
    ...
    var body: some View {
        ZStack {
            ...
            // Duotone photo layered over the brand gradient (ZStack: gradient
            // then photo), mirroring Home's hero. Court lines + content stay on
            // top; foreground is already white.
