    ...
    private var recordSummaryCard: some View {
        ...
        return HStack(spacing: 16) {
            VStack(alignment: .leading, spacing: 4) {
                // Inline white uppercase label (replaces inkSoft Eyebrow on photo).
        ...
        .padding(16)
        // "Hero + select cards": ONLY the top record/summary card gets a photo
        // (PhotoCourt hero, white fg). All charts/stat panels below stay clean.
